...
- [`30f5474`](https://github.com/santi020k/lumen/commit/30f5474844d84e96e5d257e213f5c70afb067a48) Thanks [@santi020k](https://github.com/santi020k)! - Make the React catalog safe to import from Next.js Server Components through an explicit client
  boundary. Adopt React 19 ref props for Button, Link, ButtonLink, and Input, add Button child
  composition, and restore the native numeric Input size attribute while moving visual sizing to
  visualSize.
...
- [`bf6ea87`](https://github.com/santi020k/lumen/commit/bf6ea8786fdb307bf7b3fc2313e5a2850bfdf579) Thanks [@santi020k](https://github.com/santi020k)! - Add headless React behavior hooks and wired primitives for Dialog, Popover, DropdownMenu, Tabs, Select, Toast, and Tooltip, matching the Astro runtime's ARIA, keyboard, dismissal, and toast controller semantics.
