...
export const lumenComponentBehavior = {
  ...
  Backdrop: { astro: 'none', elements: 'registered-element', react: 'component' },
  ...
  ComboChart: { astro: 'none', elements: 'registered-element', react: 'component' },
  ...
  ErrorState: { astro: 'none', elements: 'registered-element', react: 'component' },
  ...
  PhoneInput: { astro: 'ui-primitives', elements: 'registered-element', react: 'component' },
  ...
  RangeChart: { astro: 'none', elements: 'registered-element', react: 'component' },
  ...
  ScatterChart: { astro: 'none', elements: 'registered-element', react: 'component' },
