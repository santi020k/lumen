...
const frameworkSearchText = (component: LumenComponentSnapshot, framework?: LumenFramework) => (framework ? [Reflect.get(component.frameworkDetails, framework)] : Object.values(component.frameworkDetails))
...
export const diagnose = (
  ...
  const checks = [
    ...
    },
    {
      ...
      status: data.components.every(component => (Object.entries(component.frameworks) as [LumenFramework, boolean][]).every(([framework, available]) => {
