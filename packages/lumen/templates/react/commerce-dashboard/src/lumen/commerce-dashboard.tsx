  ...
  <div className="lumen-template lumen-template__shell">
    ...
    <main className="lumen-template__main" id="overview">
      <header className="lumen-template__header">
        <div>
          <Badge variant="outline">Store overview</Badge>
          <h1>Commerce command center</h1>
          <p>Sales, fulfillment, and inventory risk.</p>
        </div>
        <Button>Add product</Button>
      </header>
      <section
        className="lumen-template__metrics"
        aria-label="Commerce metrics"
      >
        <Card className="lumen-template__metric">
          <Stat label="Gross sales" value="$92,840" />
          <Badge variant="success">+18.6%</Badge>
        </Card>
        <Card className="lumen-template__metric">
          <Stat label="Orders" value="1,284" />
          <Badge variant="success">+7.4%</Badge>
        </Card>
        <Card className="lumen-template__metric">
          <Stat label="Average order" value="$72.31" />
          <Badge variant="success">+$6.20</Badge>
        </Card>
        <Card className="lumen-template__metric">
          <Stat label="Return rate" value="2.1%" />
          <Badge variant="success">-0.4%</Badge>
        </Card>
      </section>
      <section className="lumen-template__grid">
        <BarChart heading="Sales this week" series={sales} />
        <PieChart
          centerLabel="orders"
          centerValue="1,284"
      ...
      <section className="lumen-template__grid" id="inventory">
        <Card className="lumen-template__panel">
          <h2>Fulfillment</h2>
          <Stat label="Orders ready" value="42" />
          <Progress
            aria-label="42 of 58 orders fulfilled"
            max={58}
            value={42}
          />
        </Card>
        <Card className="lumen-template__panel">
          ...
          <ul className="lumen-template__list">
            <li>3 products below safety stock</li>
            <li>8 transfers arriving this week</li>
            <li>94% inventory accuracy</li>
          </ul>
        </Card>
      </section>
      <Card className="lumen-template__panel" id="orders">
