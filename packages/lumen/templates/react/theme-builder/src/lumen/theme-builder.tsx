...
import { createThemeFromHue, exportThemeCss } from '@santi020k/lumen-core'
import { Button, Card, Input, ThemeBuilder } from '@santi020k/lumen-react'
  ...
  return (
    <ThemeBuilder className="lumen-recipe lumen-recipe--theme-builder">
      ...
      <Card id="lumen-theme-preview" style={previewStyle}>
        <span
          data-ui-swatch
          style={{ '--ui-swatch': 'hsl(var(--brand))' } as CSSProperties}
        >
        </span>
        <span
          data-ui-swatch
          style={{ '--ui-swatch': 'hsl(var(--accent))' } as CSSProperties}
        >
        </span>
      </Card>
      <Card>
