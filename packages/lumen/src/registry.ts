...
] as const satisfies readonly LumenRegistryComponent[]
...
export const lumenRegistry = {
  ...
  components: lumenRegistryComponents
...
const isLumenRegistry = (value: unknown): value is LumenRegistry => {
  ...
  return typeof registry.name === 'string' &&
    ...
    (registry.components === undefined || Array.isArray(registry.components)) &&
