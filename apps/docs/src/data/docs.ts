...
const dialogTriggerApiRows = (name: string) =>
  [
    apiRow(
      ...
      "string",
      "-",
      "Connects the dialog surface to a matching trigger attribute value.",
    ),
    apiRow(
      `data-ui-${name}-trigger`,
      "target id",
      "-",
      "Marks an external trigger and points it at the dialog id.",
    ),
    apiRow(
      `data-ui-${name}-close`,
      "boolean attribute",
      "-",
      "Marks a child control that closes the nearest dialog.",
    ),
  ] as const;
...
> = {
  ...
  ListBox: keyboardRows(
    ...
    ["Home / End", "Moves to the first or last enabled option."],
    ["Space / Enter", "Selects or toggles the active option."],
    [
      "Type characters",
...
> = {
  DataTable: runtimeEvents.filter(
    (event) =>
      event.name === "ui:data-table-selection-change" ||
      event.name === "ui:datatable-selection-change",
  ),
  Field: runtimeEvents.filter(
    (event) =>
      event.name === "ui:validate" ||
      event.name === "ui:invalid" ||
      event.name === "ui:valid",
  ),
  RichTextEditor: runtimeEvents.filter((event) =>
    event.name.startsWith("ui:editor-"),
  ),
  ...
  ThemeBuilder: runtimeEvents.filter(
    (event) =>
      event.name === "ui:theme-change" || event.name === "ui:theme-export",
  ),
...
const apiReferenceByComponent = {
  ...
  Attachment: [
    apiRow(
      ...
      "string",
      "-",
      "Renders the root as a link when provided; otherwise renders an article.",
    ),
  ],
  Autocomplete: [
    apiRow(
      ...
      "string",
      "required",
      "Connects the search input to a datalist id.",
    ),
    apiRow(
      "type",
      "HTML input type",
      '"search"',
      "Sets the native input type.",
    ),
  ],
  Avatar: [
    ...
    apiRow(
      ...
      "string",
      "-",
      "Fallback text shown when no image source is provided.",
    ),
  ],
  AnimatedLogo: [
    apiRow(
    ...
    apiRow(
      "--ui-animated-logo-duration",
      "CSS time",
      '"700ms"',
      "Customizes the reveal duration.",
    ),
    apiRow(
      "--ui-animated-logo-delay",
      "CSS time",
      '"0ms"',
      "Delays the reveal for coordinated compositions.",
    ),
  ],
  AnimatedPortrait: [
    apiRow(
      ...
      "required",
      "Sets the portrait image source.",
    ),
    apiRow(
      "alt",
      "string",
      "required",
      "Provides the portrait image accessible text.",
    ),
    apiRow(
      "showFloatingBadges",
      "boolean",
  ...
  BarChart: [
    ...
    apiRow(
      ...
      "number",
      "112",
      "Reserves 64–240 SVG units for horizontal category labels.",
    ),
    apiRow(
      "formatCategory, formatValue",
      "formatter functions",
      "String",
      "Formats axes, SVG titles, and the accessible data table without changing data identity.",
    ),
    apiRow(
      "emptyLabel",
      "string",
      '"No chart data available."',
      "Provides actionable, source-specific empty-state guidance.",
    ),
    apiRow(
      "showLegend",
      "boolean",
      "true for multiple series",
      "Shows the color-independent series key.",
    ),
    apiRow(
      "showTable",
      "boolean",
      "true",
      "Provides a revealable semantic table containing every plotted value.",
    ),
    apiRow(
  ...
  Bubble: [
    apiRow(
      ...
      '"assistant" | "user"',
      '"assistant"',
      "Aligns and styles the bubble for the message author.",
    ),
  ],
  Breadcrumb: [
    apiRow(
  ...
  ButtonLink: [
    ...
    apiRow(
      ...
      '"default" | "icon"',
      '"default"',
      'Renders a round icon-only link when set to "icon".',
    ),
    apiRow(
      "showArrow",
      "boolean",
      "false",
      "Appends a directional arrow icon.",
    ),
    apiRow(
      "newTab",
      "boolean",
  ...
  CardContent: [
    ...
    apiRow(
      ...
      '"card-content"',
      "generated",
      "Provides the stable public styling hook for the card body.",
    ),
  ],
  CardDescription: [
    apiRow(
      ...
      '"div" | "p"',
      '"div"',
      "Uses a paragraph only when the supplied content is phrasing content.",
    ),
    apiRow(
      "data-slot",
      '"card-description"',
  ...
  CardFooter: [
    ...
    apiRow(
      ...
      '"card-footer"',
      "generated",
      "Provides the stable public styling hook for card actions.",
    ),
  ],
  CardHeader: [
    apiRow(
  ...
  CardTitle: [
    ...
    apiRow(
      ...
      '"card-title"',
      "generated",
      "Provides the stable public styling hook for the card title.",
    ),
  ],
  Calendar: [
    apiRow(
      ...
      "boolean",
      "false",
      "Disables month navigation, date selection, and the hidden form input.",
    ),
    apiRow(
      "max",
      "YYYY-MM-DD string",
      "-",
      "Disables dates after the inclusive maximum date.",
    ),
    apiRow(
      "min",
      "YYYY-MM-DD string",
      "-",
      "Disables dates before the inclusive minimum date.",
    ),
    apiRow(
      "month",
      "YYYY-MM string",
      "current or selected month",
      "Sets the initially visible month.",
    ),
    apiRow(
      "name",
      "string",
      "-",
      "Sets the name of the hidden input that stores the selected ISO date.",
    ),
    apiRow(
      "value",
      "YYYY-MM-DD string",
      '""',
      "Sets the selected date and hidden input value.",
    ),
  ],
  Callout: [
    apiRow(
  ...
  Carousel: [
    apiRow(
      ...
      "boolean attribute",
      "-",
      "Marks the scrollable slide viewport.",
    ),
    apiRow(
  ...
  Chart: [
    apiRow(
      ...
      '"default" | "bare"',
      '"default"',
      "Removes the frame, background, shadow, and padding when a chart is composed inside Card.",
    ),
    apiRow(
      "children",
    ...
    apiRow(
      ...
      "string",
      "-",
      "Adds a semantic figcaption after the custom plot.",
    ),
  ],
  Checkbox: [
    apiRow(
      ...
      "boolean",
      "-",
      "Uses the native checkbox checked state.",
    ),
  ...
  Code: [
    apiRow(
      ...
      '"inline" | "block"',
      '"inline"',
      "Switches between inline code and a framed code block.",
    ),
    apiRow(
      "code",
      "string",
      "-",
      "Renders normalized multiline code with semantic, theme-token-based syntax colors.",
    ),
    apiRow(
      "language",
      "string",
    ...
    apiRow(
      ...
      "string",
      "-",
      "Adds a compact filename or title to the block header.",
    ),
    apiRow(
      "copy",
      "boolean",
      "false",
      "Shows a copy button when UIPrimitives is mounted.",
    ),
    apiRow(
      "highlighted",
      "boolean",
    ...
    apiRow(
      "theme",
      '"auto" | "lumen" | "santi020k"',
      '"auto"',
      "Selects the code palette family.",
    ),
    apiRow(
      "wrap",
      "boolean",
  ...
  CodeTabs: [
    ...
    apiRow(
      ...
      "string",
      "first item value",
      "Selects the matching code example before interaction.",
    ),
    apiRow(
      "storageKey",
      "string",
      "-",
      "Persists selection and synchronizes CodeTabs instances that share this key.",
    ),
    apiRow(
      "copy",
      "boolean",
      "true",
      "Shows a copy button for each code example.",
    ),
    apiRow(
      "theme",
      '"auto" | "lumen" | "santi020k"',
    ...
    apiRow(
      ...
      "boolean",
      "true",
      "Wraps long code lines instead of requiring horizontal scrolling.",
    ),
  ],
  Collapsible: [
    apiRow(
      ...
      "boolean",
      "false",
      "Uses the native details open state to show the collapsible content.",
    ),
    apiRow(
      "children",
  ...
  CoverImage: [
    apiRow(
      ...
      "ImageMetadata",
      "required",
      "Sets the source image processed by astro:assets.",
    ),
    apiRow(
      "alt",
      "string",
      "required",
      "Sets the alt text, or pass ariaHidden for decorative covers.",
    ),
    apiRow(
      "mode",
      '"card" | "detail"',
      '"card"',
      "Switches between the card crop and the contained detail frame.",
    ),
    apiRow(
      "hover",
      "boolean",
      "false",
      "Lifts the cover on hover (respects reduced motion).",
    ),
    apiRow(
      "showBottomGradient",
      "boolean",
      "false",
      "Overlays a bottom-to-top fade for legible captions.",
    ),
  ],
  Combobox: [
    apiRow(
  ...
  Command: [
    apiRow(
      ...
      "boolean attribute",
      "-",
      "Marks filterable command items for the runtime.",
    ),
  ],
  ...
  DataTable: [
    ...
    apiRow(
      ...
      "DataTableRow[]",
      "[]",
      "Generates table body rows from structured data.",
    ),
    apiRow(
      "name",
      "string",
    ...
    apiRow(
      ...
      "boolean",
      "false",
      "Enables selectable row behavior for the UIPrimitives runtime.",
    ),
  ],
  DateRangePicker: [
    apiRow(
  ...
  DatePicker: [
    ...
    apiRow(
      ...
      "string",
      '"Choose a date"',
      "Labels the trigger before a date is selected.",
    ),
    apiRow(
      "UIPrimitives",
      "Astro runtime",
  ...
  Direction: [
    apiRow(
      ...
      '"ltr" | "rtl" | "auto"',
      '"ltr"',
      "Sets text and layout direction for the subtree.",
    ),
  ],
  ...
  DropdownMenu: [
    ...
    apiRow(
      ...
      "child panel",
      "-",
      'Marks the dropdown panel that contains role="menuitem" actions.',
    ),
  ],
  Empty: [
    apiRow(
  ...
  FloatingBadge: [
    apiRow(
      ...
      "number | short text",
      "required",
      "Provides the compact overlaid notification value.",
    ),
  ],
  FormattedDate: [
    apiRow(
    ...
    apiRow(
      ...
      "required",
      "Provides the localized text shown to people.",
    ),
  ],
  ...
  Icon: [
    apiRow(
      ...
      "string",
      "-",
      "Renders any Lucide icon by name, including kebab-case names and Lucide aliases.",
    ),
    apiRow(
      "label",
      "string",
      "-",
      "Adds an accessible name and exposes the icon as an image.",
    ),
    apiRow(
      "decorative",
      "boolean",
      "true when unlabelled",
      "Keeps decorative icons hidden from assistive technology.",
    ),
    apiRow(
      "size",
      '"default" | "sm" | "lg" | "xl"',
      '"default"',
      "Controls the icon box size.",
    ),
  ],
  Image: [
    apiRow(
  ...
  Field: [
    apiRow(
      ...
      "string",
      "-",
      "Connects the field to a control elsewhere in the field root.",
    ),
    apiRow(
      "describedBy",
      "space-separated ids",
      "-",
      "Adds ids to the control aria-describedby value.",
    ),
    apiRow(
      "data-ui-form",
      "boolean attribute",
      "-",
      "Opts a form into native Constraint Validation API enhancement.",
    ),
    apiRow(
  ...
  Input: [
    ...
    apiRow(
      ...
      '"default" | "sm" | "lg"',
      '"default"',
      "Controls the field height and font size.",
    ),
  ],
  InputGroup: [
    apiRow(
  ...
  InputOTP: [
    ...
    apiRow(
      ...
      "boolean",
      "false",
      "Disables the native input and generated visual segments.",
    ),
    apiRow(
      "length",
      "number",
      "6",
      "Sets the number of visual code segments and the default maxlength.",
    ),
    apiRow(
      "maxlength",
      "number",
      "length",
      "Overrides the native maximum character count.",
    ),
    apiRow(
      "inputmode",
      "HTML inputmode value",
      '"numeric"',
      "Hints the preferred on-screen keyboard.",
    ),
    apiRow(
      "pattern",
      "string",
      '"[0-9]*"',
      "Sets the native input pattern for accepted characters.",
    ),
  ],
  Marker: [
    apiRow(
  ...
  LanguageToggle: [
    apiRow(
      ...
      "locale label",
      "required",
      "Shows the current locale or language abbreviation.",
    ),
    apiRow(
      "type",
      '"button" | "submit" | "reset"',
  ...
  Link: [
    ...
    apiRow(
      ...
      "anchor attributes",
      "-",
      "Forwards native navigation and relationship attributes.",
    ),
  ],
  LineChart: [
    apiRow(
    ...
    apiRow(
      "markers",
      '"auto" | "all" | "none" | boolean | number',
      '"auto"',
      "Controls marker density; a number displays every nth point while retaining all line and table data.",
    ),
    apiRow(
      "formatCategory, formatValue",
      "formatter functions",
    ...
    apiRow(
      ...
      "number",
      "-",
      "Draws a dashed threshold or comparison line across the plot.",
    ),
    apiRow(
      "showLegend",
      "boolean",
  ...
  Message: [
    apiRow(
      ...
      '"assistant" | "user"',
      '"assistant"',
      "Aligns and styles the message for the author.",
    ),
  ],
  MessageScroller: [
    apiRow(
  ...
  Note: [
    apiRow(
      ...
      "string",
      "-",
      "Adds an emphasized label above the note content.",
    ),
    apiRow(
      "borderPosition",
      '"left" | "right" | "none"',
  ...
  NativeSelect: [
    apiRow(
      ...
      "Array<string | { label, value, disabled? }>",
      "[]",
      "Creates native option elements.",
    ),
    ...
    apiRow(
      ...
      '"default" | "sm" | "lg"',
      '"default"',
      "Controls select height and font size.",
    ),
  ],
  NavigationMenu: [
    surfaceApiRow,
  ...
  Pagination: [
    apiRow(
      ...
      "string",
      '"Pagination"',
      "Sets the accessible name of the pagination navigation landmark.",
    ),
    apiRow(
      "children",
  ...
  PhoneInput: [
    ...
    apiRow(
      ...
      "string",
      '"country"',
      "Sets the name of the country dial-code select.",
    ),
    apiRow(
      "countryLabel",
      "string",
      '"Country code"',
      "Sets the accessible label for the dial-code select.",
    ),
    apiRow(
      "countryValue",
      "string",
      "-",
      "Selects the initial dial code by value.",
    ),
    apiRow(
      "name",
      "string",
      '"phone"',
      "Sets the name of the telephone number input.",
    ),
    apiRow(
      "placeholder",
      "string",
      '"Phone number"',
      "Sets the placeholder for the number input.",
    ),
    apiRow(
      "size",
      '"default" | "sm" | "lg"',
      '"default"',
      "Controls the height and font size of both controls.",
    ),
  ],
  PieChart: [
    apiRow(
    ...
    apiRow(
      ...
      '"donut" | "pie"',
      '"donut"',
      "Uses a center opening by default or renders a traditional pie.",
    ),
    apiRow(
    ...
    apiRow(
      ...
      "boolean",
      "true",
      "Shows the color-independent category key.",
    ),
    apiRow(
      "showTable",
      "boolean",
  ...
  Pill: [
    apiRow(
      ...
      "number | string",
      "-",
      "Appends a muted count affix after the pill label.",
    ),
    apiRow(
      "href",
      "string",
      "-",
      "Renders the pill as a focusable anchor when it represents a destination.",
    ),
    apiRow(
      "variant",
  ...
  Progress: [
    apiRow(
      ...
      "number",
      "0",
      "Sets the current progress value, clamped between 0 and max.",
    ),
  ...
  RadioGroup: [
    ...
    apiRow(
      ...
      "string",
      "-",
      "Names the radio group when no visible legend is supplied.",
    ),
  ],
  Resizable: [
    apiRow(
      ...
      "number[]",
      "-",
      "Sets initial pane sizes as percentages, serialized for the runtime.",
    ),
    apiRow(
      "direction",
      '"horizontal" | "vertical"',
    ...
    apiRow(
      ...
      "number | number[]",
      "-",
      "Limits pane growth by percentage; pass an array for per-pane limits.",
    ),
    apiRow(
      "minSize",
      "number | number[]",
  ...
  ScrollProgress: [
    apiRow(
      ...
      '"top" | "bottom"',
      '"top"',
      "Pins the progress indicator to a viewport edge.",
    ),
    apiRow(
      "aria-label",
      "string",
  ...
  Select: [
    ...
    apiRow(
      ...
      "string",
      "-",
      "Adds a disabled placeholder option and trigger placeholder text.",
    ),
    apiRow(
      "size",
      '"default" | "sm" | "md" | "lg"',
    ...
    apiRow(
      ...
      "boolean",
      "false",
      "Disables the native select and enhanced trigger.",
    ),
    apiRow(
      "required",
      "boolean",
      "false",
      "Forwards required validation to the native select.",
    ),
    apiRow(
      "value",
      "string | number",
  ...
  Skeleton: [
    ...
    apiRow(
      "role",
      "ARIA role",
      '"status" when labelled',
      "Overrides the generated status role.",
    ),
  ],
  SkipLink: [
    apiRow(
  ...
  Sonner: [
    ...
    apiRow(
      ...
      "number",
      "3",
      "Limits the number of simultaneously visible runtime toasts.",
    ),
  ],
  Sparkline: [
    apiRow(
      ...
      "number[]",
      "required",
      "Provides ordered values for the compact trend.",
    ),
    apiRow(
      "label",
      "string",
    ...
    apiRow(
      ...
      "boolean",
      "false",
      "Adds a subtle tokenized fill below the line.",
    ),
    apiRow(
      "showEndpoint",
      "boolean",
      "true",
      "Marks the latest value with a color-independent endpoint.",
    ),
    apiRow(
      "tone",
      "LumenChartTone",
      '"series-1"',
      "Selects a categorical or explicitly semantic chart tone.",
    ),
  ],
  SpeedDial: [
    apiRow(
    ...
    apiRow(
      ...
      '"up" | "down" | "left" | "right"',
      '"up"',
      "Controls the direction in which actions expand.",
    ),
    apiRow(
      "label",
      "string",
      '"Actions"',
      "Names both the trigger and its action menu for assistive technology.",
    ),
    apiRow(
      "UIPrimitives",
      "Astro runtime",
  ...
  Switch: [
    ...
    apiRow(
      ...
      "ARIA role",
      '"switch"',
      "Sets the switch role on the checkbox input.",
    ),
    apiRow("type", '"checkbox"', '"checkbox"', "Fixed by the component."),
  ],
  Table: [
  ...
  Tabs: [
    ...
    apiRow(
      ...
      "string",
      "-",
      "Astro: selects the matching data-value before interaction.",
    ),
    apiRow(
      "storageKey",
      "string",
      "-",
      "Astro: persists selection and synchronizes tab groups that share this key.",
    ),
  ],
  TagGroup: [
    apiRow(
      ...
      "boolean attribute",
      "-",
      "Marks each tag item for group behavior.",
    ),
    apiRow(
      "data-ui-tag-remove",
      "boolean attribute",
  ...
  ThemeBuilder: [
    ...
    apiRow(
      ...
      "-",
      "Controls the generated brand hue.",
    ),
    apiRow(
  ...
  ThemeToggle: [
    apiRow(
      ...
      "string",
      '"lumen-theme"',
      "Sets the local-storage key used to persist the selected theme.",
    ),
    apiRow(
  ...
  Toast: [
    ...
    apiRow(
      ...
      "number",
      "5",
      "Limits the number of runtime toasts kept in the notification viewport.",
    ),
    apiRow(
  ...
  Tree: [
    apiRow(
      ...
      "ARIA role",
      '"tree"',
      "Generated tree role for the root element.",
    ),
    apiRow(
  ...
  TreeGrid: [
    apiRow(
      ...
      "ARIA role",
      '"treegrid"',
      "Generated treegrid role for the root element.",
    ),
    apiRow(
  ...
  Particles: [
    apiRow(
      ...
      '"low" | "medium" | "high"',
      '"medium"',
      "Controls the density of the particles.",
    ),
  ],
  AnimatedNumber: [
    apiRow(
    ...
    apiRow(
      ...
      "string",
      "browser locale",
      "Formats the value with Intl.NumberFormat.",
    ),
    apiRow(
      "prefix, suffix",
      "string",
      '""',
      "Adds stable text around the formatted number.",
    ),
    apiRow(
      "duration",
      '"fast" | "standard" | "slow"',
      '"slow"',
      "Uses the shared Lumen motion duration.",
    ),
  ],
  RevealGroup: [
    apiRow(
    ...
    apiRow(
      ...
      "number",
      "80",
      "Sets the delay in milliseconds between direct children.",
    ),
    ...
    apiRow(
      ...
      "boolean",
      "true",
      "When false, children transition again when the group re-enters the viewport.",
    ),
    apiRow(
      "threshold",
      "number",
      "0.15",
      "Sets the visible intersection ratio that starts the reveal.",
    ),
  ],
  ScrollReveal: [
    apiRow(
    ...
    apiRow(
      ...
      "boolean",
      "true",
      "When false, the content transitions again when it re-enters the viewport.",
    ),
    apiRow(
      "threshold",
      "number",
  ...
  StatDescription: [
    apiRow(
      ...
      '"div" | "p"',
      '"div"',
      "Uses a paragraph only when the supporting content is phrasing content.",
    ),
    apiRow(
      "data-slot",
      '"stat-description"',
  ...
  StatIcon: [
    ...
    apiRow(
      ...
      '"stat-icon"',
      "generated",
      "Provides the stable public styling hook for the icon container.",
    ),
  ],
  StatLabel: [
    apiRow(
      ...
      '"div" | "span"',
      '"div"',
      "Changes the label wrapper without adding heading semantics.",
    ),
    apiRow(
      "data-slot",
      '"stat-label"',
      "generated",
      "Provides the stable public styling hook for the metric label.",
    ),
  ],
  StatTrend: [
    apiRow(
  ...
  Meter: [
    ...
    apiRow(
      ...
      "number",
      "0, 100",
      "Sets the inclusive measurement range.",
    ),
    apiRow(
      "low, high, optimum",
      "number",
      "-",
      "Defines qualitative ranges for the native meter element.",
    ),
  ],
  Rating: [
    ...
    apiRow(
      ...
      "boolean",
      "false",
      "Presents the rating without interactive score controls.",
    ),
  ],
  Timeline: [
    apiRow(
  ...
  Stepper: [
    apiRow(
      "steps",
      "Array<string | { label, description? }>",
      "[]",
    ...
    apiRow(
      ...
      '"horizontal" | "vertical"',
      '"horizontal"',
      "Controls the step layout direction.",
    ),
  ],
  FileUpload: [
    apiRow(
      ...
      "string",
      '"Choose a file"',
      "Sets the visible upload action label.",
    ),
    apiRow(
      "hint",
      "string",
      "-",
      "Adds supporting file type or size guidance.",
    ),
    apiRow(
  ...
  Tour: [
    apiRow(
      "steps",
      "Array<{ target, content, title? }>",
      "[]",
      "Defines the ordered anchored guidance steps.",
    ),
    apiRow(
      "nextLabel, closeLabel",
      "string",
      '"Next", "Close"',
      "Sets the tour navigation action labels.",
    ),
  ],
  Anchor: [
    apiRow(
  ...
  Segmented: [
    ...
    apiRow(
      ...
      "string",
      "-",
      "Controls or initializes the selected value.",
    ),
    ...
    apiRow(
      ...
      '"default" | "sm" | "lg"',
      '"default"',
      "Controls the segment height and spacing.",
    ),
  ],
  Toolbar: [
    apiRow(
    ...
    apiRow(
      ...
      "string",
      "-",
      "Provides the toolbar accessible name.",
    ),
  ],
  Descriptions: [
    apiRow(
      ...
      "Array<{ label, value }>",
      "[]",
      "Defines the labelled facts.",
    ),
    apiRow(
      "columns",
      "number",
      "1",
      "Sets the preferred number of aligned columns.",
    ),
  ],
  Popconfirm: [
    apiRow(
      ...
      "string",
      '"Are you sure?"',
      "Sets the concise confirmation question.",
    ),
    apiRow(
      "confirmLabel, cancelLabel",
      "string",
      '"Confirm", "Cancel"',
      "Sets the action labels.",
    ),
  ],
  Transfer: [
    apiRow(
      ...
      "TransferItem[]",
      "[]",
      "Defines the available and initially chosen collections.",
    ),
    apiRow(
      "sourceTitle, targetTitle",
      "string",
      '"Available", "Selected"',
      "Labels the two collections.",
    ),
  ...
  Cascader: [
    apiRow(
      ...
      "CascaderOption[]",
      "[]",
      "Defines the hierarchical option branches.",
    ),
    ...
    apiRow(
      ...
      "string",
      '"Select"',
      "Sets the trigger text before a path is selected.",
    ),
  ],
  TreeSelect: [
    ...
    apiRow(
      ...
      "string",
      '"Select"',
      "Sets the trigger text before a node is selected.",
    ),
  ],
  Mentions: [
    apiRow(
      ...
      "[]",
      "Defines the mention suggestions.",
    ),
    apiRow(
      "trigger",
      "string",
      '"@"',
      "Sets the character that opens suggestions.",
    ),
    apiRow(
      "name, placeholder",
      "string",
      "-",
      "Sets the native textarea field name and hint.",
    ),
  ],
  QRCode: [
    apiRow(
      ...
      "Generates a QR code from the supplied value.",
    ),
    apiRow(
      "src",
      "string",
      "-",
      "Uses an existing QR image instead of generating one.",
    ),
  ...
  Watermark: [
    apiRow(
      ...
      "string",
      '"Lumen"',
      "Sets the repeated watermark text.",
    ),
  ...
  Affix: [
    apiRow(
      ...
      '"top" | "bottom"',
      '"top"',
      "Selects the viewport edge used for sticky positioning.",
    ),
    apiRow(
  ...
  CheckboxGroup: [
    apiRow(
      ...
      "string",
      "-",
      "Adds the visible fieldset legend for the related checkbox choices.",
    ),
    apiRow(
      "orientation",
      '"horizontal" | "vertical"',
    ...
    apiRow(
      ...
      "boolean",
      "false",
      "Marks the group invalid for validation feedback.",
    ),
  ],
  Container: [
    apiRow(
      ...
      '"div"',
      "Changes the semantic root.",
    ),
    apiRow(
      "size",
      '"sm" | "md" | "lg" | "full"',
      '"lg"',
      "Controls the maximum inline size.",
    ),
  ],
  ErrorSummary: [
    apiRow(
      ...
      "LumenFormErrorInput",
      "-",
      "Normalizes form and field errors into a linked summary.",
    ),
    apiRow(
      "heading",
      "string",
    ...
    apiRow(
      ...
      "string",
      '"ui-error-summary"',
      "Sets the focus target and heading relationship.",
    ),
  ],
  FieldError: [
    apiRow(
      ...
      "string",
      "-",
      "Shows the error text and reveals the live field error region.",
    ),
    apiRow(
      "children",
      "phrasing content",
      "-",
      "Overrides the message prop with authored content.",
    ),
  ],
  Form: [
    apiRow(
      ...
      "boolean",
      "true",
      "Enables Lumen constraint-validation enhancement.",
    ),
    apiRow(
      "status",
  ...
  Grid: [
    ...
    apiRow(
      ...
      '1 | 2 | 3 | 4 | 6 | 12 | "auto"',
      '"auto"',
      "Controls the preferred column count.",
    ),
    apiRow(
      "gap",
      '"none" | "sm" | "md" | "lg" | "xl"',
    ...
    apiRow(
      ...
      "CSS length",
      "-",
      "Sets the responsive minimum item width in auto mode.",
    ),
  ],
  ListBox: [
    apiRow(
      "options",
      "Array<string | { label, value, disabled?, section? }>",
      "[]",
      "Defines options and optional accessible sections.",
    ),
    apiRow(
      "value",
      "string | string[]",
    ...
    apiRow(
      ...
      "boolean",
      "false",
      "Marks the collection busy and disables selection while options load.",
    ),
    apiRow(
      "emptyMessage",
      "string",
      '"No options available"',
      "Labels the empty collection state.",
    ),
    apiRow(
      "selectionFollowsFocus",
      "boolean",
      "false",
      "Selects each enabled option as keyboard focus moves instead of waiting for Space or Enter.",
    ),
  ],
  PasswordField: [
    ...
    apiRow(
      ...
      "string",
      "-",
      "Adds described hint or error content.",
    ),
    apiRow(
      "showLabel, hideLabel",
      "string",
      '"Show password", "Hide password"',
      "Names the visibility toggle states.",
    ),
  ],
  Stack: [
    apiRow(
      "as",
      '"article" | "div" | "fieldset" | "nav" | "section"',
      '"div"',
      "Changes the semantic root.",
    ),
    apiRow(
      ...
      '"horizontal" | "vertical"',
      '"vertical"',
      "Controls the primary layout axis.",
    ),
    apiRow(
      "gap",
      '"none" | "sm" | "md" | "lg" | "xl"',
  ...
  VisuallyHidden: [
    ...
    apiRow(
      ...
      "phrasing content",
      "required",
      "Provides content for assistive technology.",
    ),
  ],
...
export const reactHooksReference: ReactHookDoc[] = [
  {
    ...
    options: [
      hookApiRow(
        ...
        "boolean",
        "false",
        "Render as an alert dialog that blocks backdrop-click dismiss.",
      ),
      hookApiRow(
        "defaultOpen",
        "boolean",
    ...
    controller: [
      ...
      hookApiRow(
        ...
        'LumenProps<"button">',
        "-",
        "Spread onto any close button inside the dialog.",
      ),
      hookApiRow(
        "dialogRef",
      ...
      hookApiRow(
        ...
        "-",
        "State setter for controlled usage.",
      ),
    ],
  ...
  },
  {
    ...
    controller: [
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the root wrapper element.",
      ),
      hookApiRow(
        "triggerProps",
        'LumenProps<"button">',
  ...
  },
  {
    ...
    controller: [
      ...
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the menu panel with keyboard navigation.",
      ),
      hookApiRow("open", "boolean", "-", "Current open state."),
  ...
  },
  {
    ...
    controller: [
      ...
      hookApiRow(
        ...
        "-",
        "Open the menu at viewport coordinates.",
      ),
      hookApiRow("close", "() => void", "-", "Close the menu."),
    ],
  ...
  },
  {
    ...
    options: [
      ...
      hookApiRow(
        ...
        "string",
        "auto",
        "Base id for generated tab and panel ids.",
      ),
    ],
    controller: [
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the tabs root wrapper.",
      ),
      hookApiRow(
        "listProps",
        'LumenProps<"div">',
  ...
  },
  {
    ...
    options: [
      ...
      hookApiRow(
        ...
        "boolean",
        "false",
        "Mark the hidden native select as required for form validation.",
      ),
      hookApiRow(
        "name",
        "string",
        "-",
        "Name attribute for the hidden native select.",
      ),
    ...
    controller: [
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the select root wrapper.",
      ),
      hookApiRow(
        "triggerProps",
        'LumenProps<"button">',
      ...
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the visual control wrapper.",
      ),
      hookApiRow(
        "nativeSelectProps",
        'LumenProps<"select">',
      ...
      hookApiRow(
        ...
        "string",
        "-",
        "Display text for the trigger (selected label or placeholder).",
      ),
  ...
  },
  {
    ...
    controller: [
      ...
      hookApiRow(
        ...
        "ToastRecord[]",
        "-",
        "Array of all active toast records.",
      ),
    ],
  ...
  },
  {
    ...
    options: [
      ...
      hookApiRow(
        "month",
        "string",
        "selected month or today",
        "Visible month in YYYY-MM format.",
      ),
      hookApiRow(
        "min / max",
        "string",
    ...
    controller: [
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the calendar root.",
      ),
      hookApiRow(
        "inputProps",
        'LumenProps<"input">',
        "-",
        "Spread onto the hidden input.",
      ),
      hookApiRow(
        "previousProps / nextProps",
        'LumenProps<"button">',
        "-",
        "Spread onto month navigation buttons.",
      ),
      hookApiRow(
        "weeks",
        "CalendarDay[][]",
        "-",
        "Six calendar rows of generated day models.",
      ),
      hookApiRow(
        "getDayProps",
  ...
  },
  {
    ...
    controller: [
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the date range root.",
      ),
      hookApiRow(
        "rootRef",
        "RefObject<HTMLElement>",
        "-",
        "Ref to the date range root.",
      ),
      hookApiRow(
        "getStartProps",
        '(props?) => LumenProps<"input">',
        "-",
        "Returns props for the start date input.",
      ),
      hookApiRow(
        "getEndProps",
        '(props?) => LumenProps<"input">',
        "-",
        "Returns props for the end date input.",
      ),
      hookApiRow(
        "syncRange",
  ...
  },
  {
    ...
    options: [
      ...
      hookApiRow(
        ...
        "string",
        '"[0-9]*"',
        "Native pattern forwarded to the hidden input.",
      ),
    ],
    controller: [
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the OTP field root.",
      ),
      hookApiRow(
        "getInputProps",
        '(props?) => LumenProps<"input">',
        "-",
        "Returns props for the native input.",
      ),
      hookApiRow(
        "segmentsProps",
        'LumenProps<"div">',
        "-",
        "Spread onto the visual segment container.",
      ),
      hookApiRow(
        "getSegmentProps",
      ...
      hookApiRow(
        ...
        "(value) => string",
        "-",
        "Sanitize and set the current OTP value.",
      ),
    ],
  ...
  },
  {
    ...
    controller: [
      hookApiRow(
        ...
        'LumenProps<"section">',
        "-",
        "Spread onto the editor root section.",
      ),
      hookApiRow(
        "rootRef",
        "RefObject<HTMLElement>",
        "-",
        "Ref to the editor root.",
      ),
      hookApiRow(
        "executeCommand",
  ...
  },
  {
    ...
    controller: [
      hookApiRow(
        ...
        'LumenProps<"section">',
        "-",
        "Spread onto the schedule root.",
      ),
      hookApiRow(
        "rootRef",
        "RefObject<HTMLElement>",
        "-",
        "Ref to the schedule root.",
      ),
      hookApiRow(
        "getSlotProps",
      ...
      hookApiRow(
        ...
        "(detail, root?) => void",
        "-",
        "Programmatically emit a schedule change detail.",
      ),
    ],
  ...
  },
  {
    ...
    options: [
      ...
      hookApiRow(
        ...
        "boolean",
        "true",
        "Reset panes to their default sizes on handle double-click.",
      ),
      hookApiRow(
        "onSizesChange",
        "(sizes: number[]) => void",
        "-",
        "Callback fired when panes are resized.",
      ),
    ],
    controller: [
      hookApiRow(
        ...
        'LumenProps<"div">',
        "-",
        "Spread onto the resizable root.",
      ),
      hookApiRow(
        "getPanelProps",
        '(index, props?) => LumenProps<"div">',
        "-",
        "Returns data/style props for a pane.",
      ),
      hookApiRow(
        "getHandleProps",
        '(index, props?) => LumenProps<"button">',
      ...
      hookApiRow(
        ...
        "() => void",
        "-",
        "Reset to the normalized default sizes.",
      ),
    ],
  ...
  },
  {
    ...
    options: [
      ...
      hookApiRow(
        ...
        "(hue: number) => void",
        "-",
        "Callback when the accent hue changes.",
      ),
      hookApiRow(
        "defaultScheme",
        '"light" | "dark"',
      ...
      hookApiRow(
        ...
        "(scheme) => void",
        "-",
        "Callback when the scheme changes.",
      ),
      hookApiRow(
        "defaultMode",
        '"generated" | "manual"',
        '"generated"',
        "Initial builder mode.",
      ),
      hookApiRow(
        "mode",
        '"generated" | "manual"',
        "-",
        "Controlled builder mode.",
      ),
      hookApiRow(
        "defaultExportFormat",
        '"css" | "figma" | "tokens"',
    ...
    controller: [
      hookApiRow(
        ...
        'LumenProps<"section">',
        "-",
        "Spread onto the theme builder root.",
      ),
      hookApiRow(
        "hueProps",
        'LumenProps<"input">',
        "-",
        "Spread onto the hue range input.",
      ),
      hookApiRow(
        "accentHueProps",
        'LumenProps<"input">',
        "-",
        "Spread onto the accent hue range input.",
      ),
      hookApiRow(
        "primaryColorProps",
        'LumenProps<"input">',
        "-",
        "Spread onto the primary color picker input.",
      ),
      hookApiRow(
        "secondaryColorProps",
        'LumenProps<"input">',
        "-",
        "Spread onto the secondary color picker input.",
      ),
      hookApiRow(
        "outputProps",
        'LumenProps<"textarea">',
        "-",
        "Spread onto the export output textarea.",
      ),
      hookApiRow(
        "exportButtonProps",
        'LumenProps<"button">',
        "-",
        "Spread onto the copy/export button.",
      ),
      hookApiRow(
        "getModeProps",
      ...
      hookApiRow(
        ...
        "string",
        "-",
        "Current export string (CSS, Figma JSON, or design tokens JSON).",
      ),
      hookApiRow(
        "exportFormat",
        '"css" | "figma" | "tokens"',
      ...
      hookApiRow(
        ...
        "LumenThemeTokens",
        "-",
        "Current generated theme tokens.",
      ),
      hookApiRow(
        "copyExport",
        "() => Promise<string>",
        "-",
        "Copy the export value to clipboard and return it.",
      ),
    ],
