...
components=(
  ...
  "Text field" "Textarea" "Field group" "Toggle" "Settings row" "Checkbox"
  "Radio group" "Segmented control" "Picker" "Slider" "Date field" "Search field"
  "Tabs"
  "Chip" "Badge" "Link" "Divider" "Spinner" "Card" "Alert" "Alert dialog"
  "Toast" "Banner" "Progress" "Skeleton" "Graphic" "Backdrop" "Illustration"
