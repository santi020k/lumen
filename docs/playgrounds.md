...
3. Choose Exact Version and enter `1.7.0`. Use Up to Next Major Version from `1.7.0` only when the
...
- Android applications install `com.santi020k:lumen-compose:0.6.0` from Maven Central. The repository
