...
| Android playground | Latest Google Play submission rejected for a screenshot mismatch; corrected resubmission pending | [`docs/playground-publication.md`](../playground-publication.md) Android production record | May say production access was granted and a corrected resubmission is pending (claim C-14). Never say it is under review or available on Google Play until the current status is verified. |
