...
`https://github.com/santi020k/lumen`, and choose **Exact Version** `1.7.0` for a reproducible
production build. Use **Up to Next Major Version** from `1.7.0` only when the application accepts
...
Use `from: "1.7.0"` instead of `exact: "1.7.0"` for a compatible-version policy. Commit
