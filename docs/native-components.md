...
`https://github.com/santi020k/lumen`, and choose **Exact Version** `2.2.0` for a reproducible
production build. Use **Up to Next Major Version** from `2.2.0` only when the application accepts
...
Use `from: "2.2.0"` instead of `exact: "2.2.0"` for a compatible-version policy. Commit
