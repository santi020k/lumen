...
const generateSwiftWidget = tokens => `// This file is generated by scripts/generate-platform-tokens.mjs.
import SwiftUI
...
const main = async () => {
  ...
  const outputs = [
    ...
    ['packages/swift-widget/Sources/LumenWidgetUI/Tokens.generated.swift', generateSwiftWidget(tokens)],
    [
